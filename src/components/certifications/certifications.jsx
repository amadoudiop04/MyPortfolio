  ...
  return (
    <section className="py-20 px-4 sm:px-8">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-3xl sm:text-5xl font-bold text-center font-lobster bg-gradient-to-r from-indigo-400 to-pink-400 bg-clip-text text-transparent mb-16">
          Certifications
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {certifications.map((cert) => (
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-indigo-600/10 to-pink-600/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
              ...
              <div className="relative z-10">
                ...
                <div className="flex flex-wrap gap-2">
                  {cert.skills.map((skill, idx) => (
                    <span 
                      key={idx}
                      className="px-3 py-1 bg-indigo-500/20 text-indigo-300 rounded-full text-xs font-medium hover:bg-indigo-500/30 transition-colors duration-300"
                    >
                      {skill}
                    </span>
                  ))}
